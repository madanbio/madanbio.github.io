  ...
  return (      
				<div className="in">
					...
					<ul className="contact_info">
						...
						<li>
							<span className="icon"><img src="assets/svg/call.svg" alt="" className="fn__svg"/></span>
							<p>(+91) 9570261642</p>
						</li>
						<li>
							<span className="icon"><img src="assets/svg/message.svg" alt="" className="fn__svg"/></span>
					...
					<ul className="social">
						<li>
							<a href="#" target="_blank" title="twitter.com">
								<img className="fn__svg" src="assets/svg/twitter.svg" alt="twitter.com" />
							</a>
						</li>
						<li>
							<a href="#" target="_blank" title="facebook.com">
								<img className="fn__svg" src="assets/svg/facebook-logo.svg" alt="facebook.com" />
							</a>
						</li>
						<li>
							<a href="#" target="_blank" title="instagram.com">
								<img className="fn__svg" src="assets/svg/instagram.svg" alt="instagram.com" />
							</a>
						</li>
						<li>
							<a href="#" target="_blank" title="printerest.com">
								<img className="fn__svg" src="assets/svg/pinterest.svg" alt="printerest.com" />
							</a>
						</li>
						<li>
							<a href="#" target="_blank" title="youtube.com">
								<img className="fn__svg" src="assets/svg/youtube.svg" alt="youtube.com" />
							</a>
						</li>
					</ul>
				</div> 
